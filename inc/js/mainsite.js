 ...
 *
 * LastModified: 2017.02.10 at 03:54 MEZ
 */
...
require(['requirejs_common'], function () {
    ...
    require([
                'show_snippet',
                'inline_input_fields_handler',
                'add_snippet_manager',
                'ace/ace',
                'delete_snippet_manager',
                'snippet_update_manager',
                'mark_snippet_for_copy',
                'hljs',
                'search_snippet_manager'
            ],
